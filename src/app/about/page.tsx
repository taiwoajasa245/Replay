    ...
    <div>
      <div className="flex flex-col min-h-screen">
        ...
        <div className="w-full text-center mt-10">
          <h1 className="text-sm md:text-3xl md:mx-24 mx-5 tracking-wider font-medium poppins-font  ">
            ...
            effortlessly flow into one central hub. No more scattered memories
            or lost photos – Replay brings everyone together to build a shared
            visual story.
          </h1>
        </div>
